...
应用效果可见[average Joe's blog](https://www.ezdata.top)。
...
## 分页与首页行为
为了保证“第2页及以后每页显示 12 篇文章”的行为，请在站点根目录 `_config.yml` 中设置：
...
主题渲染说明：
- 首页（第1页）加载最新 12 篇文章；主题会自动取前 6 篇用于 Hero 区（1 大 + 5 列表），其余 6 篇显示于下方网格。
- 第2页及以后每页显示标准的 12 篇网格文章。
